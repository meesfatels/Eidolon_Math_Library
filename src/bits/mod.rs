// Bits System Module for Eidolon Math Library
// This module contains all bit-level mathematical operations and manipulations
// It serves as the foundation for higher-level mathematical operations
